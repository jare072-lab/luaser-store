    ...
    <section className="bg-ink">
      <div className="mx-auto max-w-content px-4 sm:px-6 py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h1 className="mt-6 font-display text-4xl sm:text-5xl leading-[1.1] text-bone">
            Manda tu diseño. <span className="italic text-gold">Te cotizamos tu pieza el mismo día.</span>
          </h1>
